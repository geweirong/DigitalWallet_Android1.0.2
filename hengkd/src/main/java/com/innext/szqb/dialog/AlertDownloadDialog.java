 ...
 * 弹出下载dialog
 */
public class AlertDownloadDialog extends DialogFragment {
    ...
    public void showOrHideTvProgress(boolean isShow) {
        mTvProgress.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }

    public void setErrorProgress() {
        mProgressBar.setProgress(0);
        mTvProgress.setText("下载出错");
        setRightText("点击重试");
    }

    public void showOrHideButton(boolean isShow) {
        mLlBottomBtn.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }

    public void setRightText(String str) {
        mLlBottomBtn.setVisibility(View.VISIBLE);
        mTvAccomplish.setText(str);
    }

    public void showOrHideContentText(boolean isShow) {
        mTvContent.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }
    ...
    private static AlertDownloadDialog newInstance(String title, String content, String leftBtnText, String rightBtnText, boolean isCancel) {
        AlertDownloadDialog dialog = new AlertDownloadDialog();
        ...
        switch (view.getId()) {
            case R.id.tv_cancel:
                if (mLeftCallBack != null) {
                    mLeftCallBack.dialogLeftBtnClick(this);
                }
                break;
            case R.id.tv_accomplish:
                if (mRightCallBack != null) {
                    mRightCallBack.dialogRightBtnClick(this);
                }
                break;
        }
    }
    ...
    public interface LeftClickCallBack {
        void dialogLeftBtnClick(AlertDownloadDialog dialog);
    }
    ...
    public interface RightClickCallBack {
        void dialogRightBtnClick(AlertDownloadDialog dialog);
    }
    ...
    public static class Builder {
        ...
        public AlertDownloadDialog build() {
            AlertDownloadDialog dialogFragment = AlertDownloadDialog.newInstance(title, content, leftBtnText, rightBtnText, isCancel);
