...
public class AlertFragmentDialog extends DialogFragment {
   ...
   /* @BindView(R.id.view_vertical)
    ...
    private static AlertFragmentDialog newInstance(String title, CharSequence content, String leftBtnText, String rightBtnText, boolean isCancel) {
...
//        mTvContent.setText(getArguments().getString("content") == null ? mTvContent.getText().toString() : getArguments().getString("content"));
        mTvContent.setText(getArguments().getCharSequence("content") == null ? mTvContent.getText().toString() : getArguments().getCharSequence("content"));
