...
public class RollView extends View {
    ...
    public void setContent(List<String> content) {
        if (content!=null&&content.size()>0){
            if(this.content!=null&&this.content.size()>0) this.content.clear();
    ...
    private void init() {
        ...
        mTextPaint.setTextSize(Tool.sp2px(mContext, 12));
        mTextPaint.setColor(ContextCompat.getColor(mContext, R.color.global_grey_black_color));
    }
