package com.innext.szqb.widget.loading;
...
public class LoadingLayout extends FrameLayout {
    ...
    /**
     * 设置重新加载按钮的显示与否，仅对当前所在的地方有效
     *
     * @param bool
     * @return
     */
    public LoadingLayout setNoDataBtnVisible(boolean bool) {
    ...
    public static class Config {
        ...
        int reloadBtnId = R.drawable.layer_list_button_style;
        int tipTextSize = 16;
